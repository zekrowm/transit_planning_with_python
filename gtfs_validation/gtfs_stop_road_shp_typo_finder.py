...
def compare_stop_to_roads(stop_id, stop_name, stop_streets, road_names,
                          roads_gdf, threshold):
    """
...
def process_typos(stops_gdf, roadways_gdf, modifiers, road_names_clean,
                  threshold):
    """
...
def main():
    ...
    logging.info(
        "Target CRS (%s) uses '%s' as its linear unit.",
        TARGET_CRS,
        crs_unit
    )
