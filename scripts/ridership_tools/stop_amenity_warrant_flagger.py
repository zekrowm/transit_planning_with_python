"""
Flags bus stops for amenity upgrades based on ridership thresholds.
...
Typical use: Batch review of bus stop needs using ArcGIS outputs or planning reports.

Inputs:
    - Excel file with stop ID, ridership, and amenity presence (Y/N)
    - Configurable thresholds and column names for each amenity
    - Aggregation option for repeated STOP_IDs

Outputs:
    - Excel workbook with:
        • Raw input data
        • All stops with boolean flag columns
        • One sheet per amenity showing stops warranting upgrades
    - Console log of status and file path
"""
