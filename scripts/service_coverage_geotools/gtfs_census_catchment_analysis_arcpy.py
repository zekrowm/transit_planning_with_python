...
jobs). Supports network-wide runs from GTFS or a shapefile of stops/lines,
and optional per-route summaries from GTFS.

Outputs:
  - Final dissolved service area and clipped demographics (shapefiles).
  - Console summaries; optional per-route CSV when enabled.
...
STOPS_FEATURE_CLASS: str = (
    r"G:\projects\dot\zkrohmal\title_6_demog_calcs_2025_10_13\routes_shp\line_2025Aug_update_v3\line_2025Aug_update_v3_selected.shp"
)

# For "gtfs" mode
GTFS_FOLDER: str = r"" #r"G:\projects\dot\zkrohmal\_data\gtfs\connector_gtfs_2025_09_11"

# Optional: filter GTFS to the following route_short_name values.
# Example: ["10A", "10B"]. Leave as [] or None to include all routes (network run).
GTFS_ROUTE_SHORT_NAMES: Optional[Sequence[str]] = [ ] #["335", "401", "402", "553", "651", "983"]

# Inputs (absolute paths)
DEMOGRAPHICS_SHP: str = (
    r"G:\projects\dot\zkrohmal\title_6_demog_calcs_2025_10_13\demog_shp"
...
BUFFERED_STOPS_SHP: str = r"G:\projects\dot\zkrohmal\title_6_demog_calcs_2025_10_13\output_v2\buffered_stops.shp"
DISSOLVED_BUFFERS_SHP: str = r"G:\projects\dot\zkrohmal\title_6_demog_calcs_2025_10_13\output_v2\dissolved_buffers.shp"
CLIPPED_DEMOGRAPHICS_SHP: str = r"G:\projects\dot\zkrohmal\title_6_demog_calcs_2025_10_13\output_v2\clipped_demographics.shp"
FINAL_EXPORT_DIR: str = r"G:\projects\dot\zkrohmal\title_6_demog_calcs_2025_10_13\output_v2\tsp_constrained_demogs_2024_07_01"
